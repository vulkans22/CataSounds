...
void weather_effect::lightning()
{
    ...
    if(one_in(LIGHTNING_CHANCE)) {
        if(g->get_levz() >= 0) {
            ...
            play_sound_effect("environment", "thunder_near", 100, 0);
