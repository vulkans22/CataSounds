...
class game
{
    ...
    private:
        ...
        time_t last_footstep_timestamp;
        bool indoor_sfx_playing = 0;
        bool outdoor_sfx_playing = 0;
        bool underground_sfx_playing = 0;
        bool day_sfx_playing = 0;
        bool night_sfx_playing = 0;
